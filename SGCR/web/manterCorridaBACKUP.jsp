...
<html lang="pt-br">
    ...
    <body>
                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li class="active" <c:if test="${operacao != 'Excluir'}"> onclick="pagamento('kit')"</c:if>><a data-toggle="tab" href="#kit"><i class="fa fa-shopping-bag"></i> Kit</a></li>
                            <li <c:if test="${operacao != 'Excluir'}"> onclick="pagamento('percurso')"</c:if>><a data-toggle="tab" href="#percurso"><i class="fa fa-map"></i> Percurso</a></li>
                            </ul>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="panel panel-primary">
                    <div class="panel-heading">Importar Kit</div>
                    <div class="panel-body">
                        <div class="col-md-12">
                            <div class="form-group">                                   
